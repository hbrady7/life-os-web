...
export function DeckClient({ firstName }: { firstName: string | null }) {
  React.useEffect(() => {
  ...
  return (
    <DayProvider>
      <DaySurface firstName={firstName} />
    </DayProvider>
  );
}
...
const OPERATE_ORDER: Record<Daypart, CardKey[]> = {
  ...
  dusk: ["hero", "dayClose", "eveningRoutine", "reflection", "goals", "todayRoutine", "glance", "morningRoutine"],
  night: ["hero", "dayClose", "eveningRoutine", "reflection", "goals", "todayRoutine", "glance", "morningRoutine"],
};
...
function DaySurface({ firstName }: { firstName: string | null }) {
  ...
  return (
    <PullToRefresh onRefresh={onRefresh}>
      ...
      >
        <Screen width="wide">
          <DeckHeader firstName={firstName} />
